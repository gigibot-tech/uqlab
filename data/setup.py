...
5. **Run packs** (train subset + eval pools) live in :mod:`uqlab.data.packs` —
   call :func:`~uqlab.data.packs.prepare_run_data_context` after this module.
...
# Re-export run-time pack helpers (canonical home: data/packs.py)
from uqlab.data.packs import (  # noqa: E402
