"""Shim: ``uq_classification.evaluation`` → ``uqlab.evaluation.evaluator``."""

import importlib

_evaluator = importlib.import_module("uqlab.evaluation.evaluator")
...
save_training_data_csv = _evaluator.save_training_data_csv
